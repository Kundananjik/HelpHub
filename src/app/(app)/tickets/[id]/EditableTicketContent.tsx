...
export function EditableTicketContent({
  ...
  return (
    <>
      ...
      <div className="mt-4 whitespace-pre-wrap break-words rounded-lg bg-slate-50 p-4 text-sm leading-relaxed text-slate-700 dark:bg-slate-800 dark:text-slate-200">
        {description}
      </div>
    </>
  );
